    ...
    if (items && items.length) {
        ...
        items.forEach(function(item) {
            ...
            if ( !hasOwnProp.call(item, 'longname') ) {
                ...
                // Filter out inherited members - only show members that belong to this class, not inherited from parent
                ...
                // Show instance members (scope !== 'static') or static members (if docdash.static is true)
                var instanceMembers = members.filter(function (m) { return m.scope !== 'static'; });
                var staticMembers = docdash.static ? members.filter(function (m) { return m.scope === 'static'; }) : [];
                var allMembers = instanceMembers.concat(staticMembers);
                ...
                // Filter out inherited methods - only show methods that belong to this class, not inherited from parent
